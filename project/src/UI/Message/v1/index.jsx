			...
			<div className="max-w-7xl mx-auto py-20 px-8 sm:px-6 lg:flex lg:items-center lg:py-24 lg:px-12">
				<div className="  text-center lg:w-0 lg:flex-auto">
					...
					<p className="mt-3 text-sm sm:text-lg text-gray-300">
						...
						материалов в Нижнем Новгороде со складов в Дзержинске. Широкий ассортимент и
						доступные цены приятно вас удивят. При необходимости вы можете приобрести
						стройматериалы с доставкой до вашего объекта или забрать товар самовывозом.
					</p>
				</div>
			</div>
		</div>
