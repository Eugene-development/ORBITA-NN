...
export async function generateMetadata({ params }) {
	...
	return {
		title: product.product_one.value + ' в Нижнем Новгороде по низкой цене со склада.',
		description:
			"У нас вы можете купить товар '" +
			product.product_one.value +
			"' по очень низкой цене. Есть услуга доставки по Нижнему Новгороду с грузчиками." +
			product.product_one.value +
