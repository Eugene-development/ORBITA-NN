import { H1, Slider, MonthProduct, Testimonials, Appeal, Message, MainText } from '@/UI'
...
export const metadata = {
	title: 'Стройматериалы в Нижнем Новгороде | Купите строительные материалы в интернет-магазине "Орбита-строй"',
	description:
		'База строительных и отделочных материалов в Нижнем Новгороде. Наш интернет магазин строительных и отделочных материалов предложит вам широчайший ассортимент и низкие цены на стройматериалы и комплектующие. Есть стройбаза со складом рядом с Нижнем Новгородом.'
}
