				...
				<figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
					<div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
						...
						<blockquote className="text-base font-semibold leading-8 text-gray-900 sm:text-lg sm:leading-9">
							<p>
								Интернет магазин базы стройматериалов "РемСтройПро" предлагает в сезоне 2024-2025
								годов наилучшие предложения по ассортименту и ценам на строительные
								и отделочные материалы, а так же на напольные покрытия и метизную
								продукцию. Если вас интересуют стройматериалы в Нижнем Новгороде, то
