...
const navigation = {
	material: [
		{ name: 'Стройматериалы', href: '/shop/rubric/stroymaterialy' },
		{ name: 'Изоляция', href: '/shop/rubric/izolyatsiya' },
		{ name: 'Отделка', href: '/shop/rubric/otdelka' }
	],
	equipment: [
		{ name: 'Инструмент', href: '/shop/rubric/instrument' },
		{ name: 'Сантехника', href: '/shop/rubric/santehnika' },
					...
					<div className="xl:grid xl:grid-cols-3 xl:gap-8">
						<div className="space-y-4">
							...
							<p className="text-sm leading-6 text-gray-300">
								База строительных и отделочных материалов. Реализация
								стройматериалов со склада и через наш строительный интернет магазин.
							</p>
