...
export const metadata = {
	title: 'Строительные материалы в Нижнем Новгороде | Купите строительные материалы в интернет-магазине "Орбита-Строй"',
	description:
		'База строительных и отделочных материалов в Нижнем Новгороде. Наш интернет магазин строительных материалов предложит вам широкий ассортимент и низкие цены. Есть стройбаза со складом рядом с Нижнем Новгородом.'
}
